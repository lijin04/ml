...
def main():
    ...
    for e in range(episodes):
        with open("./data/testcase6.in", "r") as file:
        ...
        for agent_id, agent in enumerate(agents):
            agent.model.load_state_dict(torch.load(f"./model/model6_agent_{agent_id}.pt"))
        ...
        while step < 15000:
            ...
            with open("./data/testcase61.out", "a") as file:
                # 更新战斗机状态
            ...
            if max_score < score:
                max_score = score
                for agent_id, agent in enumerate(agents):
                    torch.save(agent.model.state_dict(), f"./model/model6_agent_{agent_id}.pt")
